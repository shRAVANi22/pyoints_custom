...
A = storage.loadPly('../data/bunny/bun000_binary.ply')
print(A.shape)
print(A.dtype.descr)
B = storage.loadPly('../data/bunny/bun045_binary.ply')
print(B.shape)
print(B.dtype.descr)
C = storage.loadPly('../data/bunny/bun090_binary.ply')
print(C.shape)
print(C.dtype.descr)
...
############################################
#NICP algorithm
# Inspired by the idea of a Normal ICP algorithm proposed by Serafin and Grisetti [3] [4], a ICP variant has been developed which considers the surface orientation of the points.
